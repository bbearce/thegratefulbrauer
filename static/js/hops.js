...
function refresh_hops() {
  ...
  $('#ibu1').text(ibus[0].toFixed(3))
  $('#alpha_acid1').text(hops_properties[0]['alphaAcid'].toFixed(3))
  $('#utilization1').text(utilizations[0].toFixed(3))
  $('#Hop1').text($("select[name='hop1']").val())
  $('#ibu2').text(ibus[1].toFixed(3))
  $('#alpha_acid2').text(hops_properties[1]['alphaAcid'].toFixed(3))
  $('#utilization2').text(utilizations[1].toFixed(3))
  $('#Hop2').text($("select[name='hop2']").val())
  $('#ibu3').text(ibus[2].toFixed(3))
  $('#alpha_acid3').text(hops_properties[2]['alphaAcid'].toFixed(3))
  $('#utilization3').text(utilizations[2].toFixed(3))
